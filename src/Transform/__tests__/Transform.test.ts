...
describe("Transform", () => {
  ...
  it("should update world when position changes", () => {
    transform.px = 1;
    transform.py = 2;
    transform.pz = 3;
  ...
  it("should update world when origin changes", () => {
    transform.ox = 1;
    transform.oy = 2;
    transform.oz = 3;
    transform.copyWorldTransform(expected);
  ...
  it("should update world when origin rotation changes", () => {
    transform.ox = 1;
    transform.rox = 1;
    transform.roy = 2;
    transform.roz = 3;
  ...
  it("should update world when center rotation changes", () => {
    transform.rcx = 1;
    transform.rcy = 2;
    transform.rcz = 3;
    transform.rcs = 4;
  ...
  it("should update world when scale changes", () => {
    transform.sx = 1;
    transform.sy = 2;
    transform.sz = 3;
    transform.copyWorldTransform(expected);
  ...
  it("should update world when all properties change with set", () => {
    transform.set({
      position: [1, 2, 3],
      origin: [1, 2, 3],
      rotationOriginAxis: [1, 2, 3],
      rotationOriginScale: 4,
      rotationCenterAxis: [1, 2, 3],
      rotationCenterScale: 4,
      scale: [1, 2, 3],
    });
    transform.copyWorldTransform(expected);
  ...
  it("should update world to zero scalar identity if at least 2 scalars are 0", () => {
  ...
  it("should update world if at least 2 scalars aren't 0", () => {
  ...
  it("should not update world when no properties change with set", () => {
    transform.set();
    transform.copyWorldTransform(expected);
    expect(expected).toEqual(result);
  });

  it("should not update world with origin rotation if origin is 0", () => {
    transform.ox = 0;
    transform.rox = 1;
    transform.ros = 1;
    transform.copyWorldTransform(expected);
  ...
  it("should not update world with origin rotation if origin rotation axis is 0", () => {
    transform.ox = 1;
    transform.rox = 0;
    transform.ros = 1;
    mat4.translation([transform.ox, transform.oy, transform.oz], result);
  ...
  it("should not update world with origin rotation if origin rotation scale is 0", () => {
    transform.ox = 1;
    transform.rox = 1;
    transform.ros = 0;
    mat4.translation([transform.ox, transform.oy, transform.oz], result);
  ...
  it("should not update world with center rotation if center rotation axis is 0", () => {
    transform.rcx = 0;
    transform.rcs = 1;
    transform.copyWorldTransform(expected);
    expect(expected).toEqual(result);
  ...
  it("should not update world with center rotation if center rotation scale is 0", () => {
    transform.rcx = 1;
    transform.rcs = 0;
    // prettier-ignore
    mat4.axisRotation([transform.rcx, transform.rcy, transform.rcz], transform.rcs, result);
  ...
  it("should not update world if not dirty", () => {
    transform.px = 1;
